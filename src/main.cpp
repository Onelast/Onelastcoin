...
uint256 hashGenesisBlock("0x3b06bb5b682748b5c4b8e396f69406b2a84e4bf8f0896bef7d982edf233003d6");
...
const string strMessageMagic = "Onelast Signed Message:\n";
...
static const int64 nTargetTimespan = 30 * 60; // Onelast: 1/2 hour
static const int64 nTargetSpacing = 120; // Onelast: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Onelast miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Onelast", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbafd73f4d716ce7ffd5d417aea24c8bb4a005f21d0fb8d473a9789302c672763");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "https://bitcointalk.org/index.php?action=pm;f=outbox#msg772749";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1370989124; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2126098;

        if (fTestNet)
        {
            block.nTime    = 1370984705;
            block.nNonce   = 1218046;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x82266fec2a26eda7943932169f4a009d624b82e0ce7fab5e9267aaf63cd6e23e"));
